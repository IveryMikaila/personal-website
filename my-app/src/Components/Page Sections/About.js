...
const About = () => {
  return (
    ...
    <div className='about-content-wrapper'>
      ...
      <p className='about-content-p'>My strongest qualifications include my proficiency in HTML5, CSS3, Javascript, and React.js. I'm currently pursuing my bachelor of science degree in software engineering at Western Governors University. </p>
